<?php 
    ...
    if (isset($_POST['registerShop'])) {
        ...
        if ($userId = $userRow['user_id']) {
            ...
            $shop_contact_number = $_POST['shop_contact_number'];
            $address = $_POST['address'];
            $nearby_location = $_POST['nearby_location'];

            $query = mysqli_query($con, "INSERT INTO `shop`(`shop_id`, `shop_name`, `shop_type`, `user_id`, `shop_contact_no`, `shop_address`, `nearby_location`, `shop_photo`) VALUES ('', '$shop_name', '$shop_type', '$userId', '$shop_contact_number', '$address', '$nearby_location', '')") or die(mysqli_error($con));

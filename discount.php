                            ...
                            <ul class="nav" id="side-menu">
                                <li>
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="add_offer.php" target="iframea">Add Offers</a>  
                                        </li>
                                        <li>
                                            <a href="view_notice.php" target="iframea">Delete Offers</a>
                                        </li>
                                        <li>
                                            <a href="view_notice.php" target="iframea">View Details</a>
                                        </li>
                                        <li>
